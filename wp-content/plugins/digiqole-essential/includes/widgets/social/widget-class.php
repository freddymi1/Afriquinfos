...
class Digiqole_Social extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<?php if ( $facebook != '' ): ?>
				...
				<?php if ( $youtube != '' ): ?>
					<li><a href="<?php echo esc_url( $youtube ); ?>" target="_blank"><i class="fa fa-instagram"></i></a></li>
				<?php endif; ?>
				...
				<?php endif; ?>
				<?php if ( $behance != '' ): ?>
					<li><a href="<?php echo esc_url( $behance ); ?>" target="_blank"><i class="fa fa-behance"></i></a></li>
				<?php endif; ?>
				<?php if ( $flickr != '' ): ?>
					<li><a href="<?php echo esc_url( $flickr ); ?>" target="_blank"><i class="fa fa-flickr"></i></a></li>
				<?php endif; ?>
				<?php if ( $github != '' ): ?>
				...
				<?php endif; ?>
				<?php if ( $soundcloud != '' ): ?>
					<li><a href="<?php echo esc_url( $soundcloud ); ?>" target="_blank"><i class="fa fa-soundcloud"></i></a></li>
				<?php endif; ?>
				<?php if ( $stumbleupon != '' ): ?>
					<li><a href="<?php echo esc_url( $stumbleupon ); ?>" target="_blank"><i class="fa fa-stumbleupon"></i></a></li>
				<?php endif; ?>
				<?php if ( $tumblr != '' ): ?>
				...
				<?php if ( $vimeo != '' ): ?>
					<li><a href="<?php echo esc_url( $vimeo ); ?>" target="_blank"><i class="fa fa-vimeo"></i></a></li>
				<?php endif; ?>

				<?php if ( $vine != '' ): ?>
					<li><a href="<?php echo esc_url( $vine ); ?>" target="_blank"><i class="fa fa-vine"></i></a></li>
				<?php endif; ?>
				<?php if ( $vk != '' ): ?>
					<li><a href="<?php echo esc_url( $vk ); ?>" target="_blank"><i class="fa fa-vk"></i></a></li>
				<?php endif; ?>
				<?php if ( $xing != '' ): ?>
					<li><a href="<?php echo esc_url( $xing ); ?>" target="_blank"><i class="fa fa-xing"></i></a></li>
				<?php endif; ?>

				<?php if ( $yelp != '' ): ?>
					<li><a href="<?php echo esc_url( $yelp ); ?>" target="_blank"><i class="fa fa-yelp"></i></a></li>
				<?php endif; ?>
				<?php if ( $odnoklassniki != '' ): ?>
					<li><a href="<?php echo esc_url( $odnoklassniki ); ?>" target="_blank"><i class="fa fa-odnoklassniki"></i></a></li>
				<?php endif; ?>
			</ul>
