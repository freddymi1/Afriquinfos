                ...
                <div class="col-md-6 col-sm-6 sm-grid-content">
                        ...
                        <?php if(has_post_thumbnail()): ?>                          
                           ...
                           <div class="post-content">
                                    ...
                                    <h4 class="post-title"><a href="<?php echo esc_url( get_permalink()); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php echo esc_html(wp_trim_words( get_the_title() ,$post_sm_title_crop,'') );  ?></a></h4>
                                    <div class="post-meta">
