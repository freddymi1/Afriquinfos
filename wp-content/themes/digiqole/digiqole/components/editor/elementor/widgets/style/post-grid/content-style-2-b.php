...
$show_author_avator = isset($settings['show_author_avator']) ?
   ...
   : 'no';
?>
<div <?php post_class("loadmore-style2 digiqole-post-slider $loadmore_class"); ?>>
   <div class="post-block-style">
      <?php if ((has_post_thumbnail())) { ?>
         ...
         <div class="post-thumb ts-resize" style="background-image: url(<?php echo esc_url(digiqole_post_thumbnail(get_the_ID())); ?>);">
            ...
            <a href="<?php echo esc_url(get_permalink()); ?>" class="img-link" rel="bookmark" title="<?php the_title_attribute(); ?>">
            </a>
         ...
         <div class="post-content">
            ...
            <h4 class="post-title"><a href="<?php echo esc_url(get_permalink()); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php echo wp_trim_words(get_the_title(), $crop, ''); ?></a></h4>
