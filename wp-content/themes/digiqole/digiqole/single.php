      ...
      <div class="container">
         <?php while (have_posts()) : the_post(); ?>
            <div id="blog-ajax-load-more-container">
               ...
               <div class="blog-ajax-load-more-trigger" data-max-posts="<?php echo esc_attr($infinite_scroll_items); ?>" data-next-post-url="<?php $next_post = get_next_post();
                                                                                                                                             echo get_permalink($next_post->ID); ?>" data-content-loaded="no" data-current-post-number="1">
